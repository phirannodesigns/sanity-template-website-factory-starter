  ...
  fields: [
    {
      ...
      options: {
        ...
        message:
          'The "Width" and "Start" fields correlate with the "Grid Size" set for this Grid module. For example, say you have an 8 column grid: Setting a column width of 4 would make a 50% width column, while a start column of 5 would make it start 50% in (the 5th column of the 8-column grid).',
      },
    },
    {
      title: 'Breakpoint',
